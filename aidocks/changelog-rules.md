...
- **Never touch released version blocks.** Released = **1.0, 1.1, 1.2** (as of 2026-09-22). They are frozen history, including the terse BGT-era 1.0 lines with typos: don't fix, reword, or suggest cleanups for them. **Unreleased blocks (currently 1.3 and 1.4) are fair game** to tighten, reword, merge, or correct. If a released entry is now inaccurate, the change goes in as a new entry in the newest unreleased version. When the dev releases a version, it moves to the frozen list (dev, 2026-09-22). **1.4 is closed for new entries** (10/10, dev said "that will do it for 1.4" on 2026-09-22): new changes go in the `New in 1.5.` block at the top (opened 2026-09-22). 1.3, 1.4 and 1.5 can still be reworded until they're released.
